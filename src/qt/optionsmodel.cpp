...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::GALILEL);
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in exotic.cpp during shotdown to also remove the window positions
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeGALILELAmount:
            ...
            emit anonymizeGALILELAmountChanged(nAnonymizeGALILELAmount);
            break;
        case CoinControlFeatures:
