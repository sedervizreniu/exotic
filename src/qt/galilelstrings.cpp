...
static const char UNUSED* galilel_strings[] = {
    ...
    QT_TRANSLATE_NOOP("galilel-core", ""
                                   "To use galileld, or the -server option to galilel-qt, you must set an rpcpassword "
    ...
    QT_TRANSLATE_NOOP("galilel-core", "(31000 could be used only on mainnet)"),
    QT_TRANSLATE_NOOP("galilel-core", "(default: %s)"),
    QT_TRANSLATE_NOOP("galilel-core", "(default: 1)"),
    QT_TRANSLATE_NOOP("galilel-core", "(must be 31000 for mainnet)"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Acceptable ciphers (default: %s)"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Connect to KeePassHttp on port <port> (default: %u)"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Copyright (C) 2014-%i The Dash and PIVX Core Developers"),
    QT_TRANSLATE_NOOP("galilel-core", "Copyright (C) 2018-%i The Exotic Core Developers"),
    QT_TRANSLATE_NOOP("galilel-core", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("galilel-core", "Could not parse -rpcbind value %s as network address"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Error loading wallet.dat: Wallet requires newer version of Exotic Core"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Error: You already have pending entries in the Darksend pool"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Fee (in GALILEL/kB) to add to transactions you send (default: %s)"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Initialization sanity check failed. Exotic Core is shutting down."),
    QT_TRANSLATE_NOOP("galilel-core", "Input is not valid."),
    QT_TRANSLATE_NOOP("galilel-core", "Insufficient funds."),
    QT_TRANSLATE_NOOP("galilel-core", "Invalid -onion address: '%s'"),
    QT_TRANSLATE_NOOP("galilel-core", "Invalid -proxy address: '%s'"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "KeePassHttp id for the established association"),
    QT_TRANSLATE_NOOP("galilel-core", "KeePassHttp key for AES encrypted communication with KeePass"),
    QT_TRANSLATE_NOOP("galilel-core", "Keep N GALILEL anonymized (default: %u)"),
    QT_TRANSLATE_NOOP("galilel-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
    QT_TRANSLATE_NOOP("galilel-core", "Last Darksend was too recent."),
    QT_TRANSLATE_NOOP("galilel-core", "Last successful Darksend action was too recent."),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Darksend is idle."),
    QT_TRANSLATE_NOOP("galilel-core", "Darksend options:"),
    QT_TRANSLATE_NOOP("galilel-core", "Darksend request complete:"),
    QT_TRANSLATE_NOOP("galilel-core", "Darksend request incomplete:"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
    QT_TRANSLATE_NOOP("galilel-core", "RPC server options:"),
    QT_TRANSLATE_NOOP("galilel-core", "RPC support for HTTP persistent connections (default: %d)"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Server certificate file (default: %s)"),
    QT_TRANSLATE_NOOP("galilel-core", "Server private key (default: %s)"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "InstantX options:"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
    QT_TRANSLATE_NOOP("galilel-core", "Use N separate masternodes to anonymize funds  (2-8, default: %u)"),
    QT_TRANSLATE_NOOP("galilel-core", "Use OpenSSL (https) for JSON-RPC connections"),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Value more than Darksend pool maximum allows."),
    ...
    QT_TRANSLATE_NOOP("galilel-core", "Wallet needed to be rewritten: restart Exotic Core to complete"),
