...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Exotic Core exotic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  exotic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded exotic transaction") + "\n" +
                               "  exotic-tx [options] -create [commands]   " + _("Create hex-encoded exotic transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded exotic transaction
