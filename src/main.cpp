...
#if defined(NDEBUG)
#error "Exotic cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Exotic Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 1) return 35000 * COIN;
		
	int64_t nSubsidy;
	
	if( nHeight > 1 && nHeight <= 2500 ) {
	    nSubsidy = 0.05 * COIN;
	} else if( nHeight > 2500 && nHeight <= 12000 ) {
	    nSubsidy = 0.15 * COIN;
	} else if( nHeight > 12000 && nHeight <= 22000 ) {
	    nSubsidy = 0.2 * COIN;
	} else if( nHeight > 22000 && nHeight <= 42000 ) {
	    nSubsidy = 20 * COIN;
	} else if( nHeight > 42000 && nHeight <= 100000 ) {
	    nSubsidy = 1.5 * COIN;
	} else if( nHeight > 100000 && nHeight <= 160000 ) {
	    nSubsidy = 0.18 * COIN;
	} else {
	    nSubsidy = 0.15 * COIN;
	}
