/* src/config/exotic-config.h.  Generated from exotic-config.h.in by configure.  */
/* src/config/exotic-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://exotic.org"
