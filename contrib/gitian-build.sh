...
VERSION=
commit=false
url=https://github.com/GALILEL/GALILEL
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the exotic, gitian-builder, gitian.sigs, and exotic-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/GALILEL/GALILEL
...
then
    ...
    git clone https://github.com/GALILEL/GALILEL.SIGS.git
    git clone https://github.com/GALILEL-DETACHED.SIGS.git
